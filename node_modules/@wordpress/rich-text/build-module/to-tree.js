...
import { LINE_SEPARATOR, OBJECT_REPLACEMENT_CHARACTER, ZERO_WIDTH_NO_BREAK_SPACE } from './special-characters';
...
function fromFormat(_ref) {
  ...
  var elementAttributes = _objectSpread({}, unregisteredAttributes);
  ...
  var _loop = function _loop(i) {
    ...
    if (multilineTag) {
      if (character === LINE_SEPARATOR) {
        ...
        characterFormats = _toConsumableArray(lastSeparatorFormats).concat(_toConsumableArray(characterFormats || []));
      }
    }
