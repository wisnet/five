...
import { every, reduce, castArray, findIndex, isObjectLike, filter, first, flatMap, uniq, isFunction, isEmpty } from 'lodash';
/**
...
export function getPossibleBlockTransformations(blocks) {
  ...
  return uniq(_toConsumableArray(blockTypesForFromTransforms).concat(_toConsumableArray(blockTypesForToTransforms)));
}
/**
...
export function switchToBlockType(blocks, name) {
  ...
  if (isMultiBlock && !every(blocksArray, function (block) {
